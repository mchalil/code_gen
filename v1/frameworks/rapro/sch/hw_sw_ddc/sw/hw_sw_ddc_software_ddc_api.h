...
#define GETOUT_STRIDE0 aIOBufferStride[9] //PL_DDC_OUT
#define GETOUT_PTR_1 &aIOBufferArray[8][0] //PS_DDC_OUT
#define GETOUT_STRIDE1 aIOBufferStride[8] //PS_DDC_OUT
...
extern eLsAlgoStatus lss_ddc_hw_sw_ddc_software_close (void* hInstance) ;
